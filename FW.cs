...
namespace MyBubbles
{
	...
	/// </summary>
	public class FW : NativeWindow, IDisposable
	{ 
		public int Top;
		public int Left;
		public int Right;
		...
		protected virtual void PerformPaint(PaintEventArgs e)
		{
			...
			e.Graphics.DrawImage(todo, this.Bound);
		}
		#endregion
		...
		{ 
			if (todo == null)
				todo = new Bitmap(this.Size.Width, this.Size.Height, PixelFormat.Format32bppArgb);
			UpdateLayeredWindow(todo,name);
		}

		public Bitmap todo = null;
		public string name = string.Empty;

		public void UpdateLayeredWindow(Bitmap bitmap, string name)
		{
			todo = bitmap;
			this.name = name;
			...
			using (Graphics graphics1 = Graphics.FromImage(bitmap))
			{
			    ...
			    POINT topPos = new POINT(this.Left, Top);
				point2.x = 0;
				point2.y = 0;
				...
				User32.UpdateLayeredWindow(base.Handle, ptr1, ref topPos, ref size1, ptr2, ref point2, 0, ref blendfunction1, 2); //2=ULW_ALPHA
